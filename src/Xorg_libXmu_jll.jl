...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXmu_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6bc1fdef-f8f4-516b-84c1-6f5f86a35b20"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Xorg_libXmu", artifacts_toml) for e in artifacts["Xorg_libXmu"]]
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXmu; unsupported platform $(triplet(platform_key_abi()))")
else
